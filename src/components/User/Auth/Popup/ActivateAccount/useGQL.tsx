...
import {
  ...
  RESEND_REGISTER_CONFIRM_CODE,
} from "../../../../../graphql/auth/mutations";
import {
  TGQLRegisterConfirm,
  TGQLResendRegisterConfirmCode,
} from "../../../../../types/auth";
...
export const useGQLResendConfirmCode = () => {
  ...
  const [resendConfirmCode, { data, error, loading }] =
    useMutation<TGQLResendRegisterConfirmCode>(RESEND_REGISTER_CONFIRM_CODE, {
      errorPolicy: "all",
    });
  const GQLresendConfirmCode = async (variables: { email: string }) => {
